...
def combine_masks(ds_mcs, ds_ar, client=None, out_zarr=None, logger=None):
    ...
    # Modify global attributes if needed
...
# /pscratch/sd/b/beharrop/kmscale_hackathon/hackathon_pre/scream2D_ne120_hp8_fast.etc_filtered_nodes.for_Lexie.nc
# /pscratch/sd/b/beharrop/kmscale_hackathon/hackathon_pre/scream2D_ne120_hp8_fast.tc_filtered_nodes.for_Lexie.nc
    ...
    # TODO: rename variables in the DataSets

    # Combine masks and write to Zarr
    combine_masks(ds_mcs, ds_ar, client=client, out_zarr=out_zarr, logger=logger)
